...
function updateText(){
  if(pagenumber==1){
    ...
    document.getElementById('mines_counter_pic').style.display='inline';
  }
    ...
    document.getElementById('game_flow_pic').style.display='inline';
    document.getElementById('mines_counter_pic').style.display='none';
  }
...
function show(){
  ...
  document.getElementById('place_mines_pic').style.display='inline';
  document.getElementById('game_flow_pic').style.display='none';
  document.getElementById('mines_counter_pic').style.display='none';
  document.getElementById('prev').style.display='none';
  document.getElementById('next').style.display='none';
  ...
  document.getElementById('popup_content_1').style.display="inline";
